...
func TestLoginByEmail_Success(t *testing.T) {
	...
	_, err = cli.LoginByEmail(ctx, &pb.LoginByEmailRequest{Email: a.Email, Password: password})
...
func TestLoginByEmail_EmailNotExists(t *testing.T) {
	...
	fmt.Println("TestLoginByEmail_DocumentNotExists id (5) : ", id)
	...
	_, err = cli.LoginByEmail(ctx, &pb.LoginByEmailRequest{Email: "email@notexists.com", Password: password})
...
func TestLoginByEmail_IncorrectPassword(t *testing.T) {
	...
	_, err = cli.LoginByEmail(ctx, &pb.LoginByEmailRequest{Email: a.Email, Password: "IncorrectPassword"})
