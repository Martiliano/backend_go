...
//
// microservices => account => external => db => mongo => implementation => get_account_by_phone_repository.go
//
...
func (sMR *accountMongoRepository) GetAccountByPhoneRepository(phone string) (*account.Account, error) {
