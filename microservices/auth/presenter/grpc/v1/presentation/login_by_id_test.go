...
//
// microservices => auth => presenter => grpc => v1 => presentation => login_by_id_test.go
//
//
...
func TestLoginById_Success(t *testing.T) {
	...
	_, err = cli.LoginById(ctx, &pb.LoginByIdRequest{Id: id, Password: password})
...
func TestLoginById_IdNotExists(t *testing.T) {
	...
	fmt.Println("TestLoginById_DocumentNotExists id (5) : ", id)
	...
	_, err = cli.LoginById(ctx, &pb.LoginByIdRequest{Id: "62956508bbde2d63320a8a59", Password: password})
...
func TestLoginById_IncorrectPassword(t *testing.T) {
	...
	_, err = cli.LoginById(ctx, &pb.LoginByIdRequest{Id: id, Password: "IncorrectPassword"})
