...
//
// microservices => account => external => db => mongo => implementation => set_password_account_repository.go
//
...
func (sMR *accountMongoRepository) SetPasswordRepository(id string, passwordHash string) (int, error) {
	...
	updater := bson.D{primitive.E{Key: "$set", Value: bson.D{
		...
		primitive.E{Key: "token_set_password", Value: ""},
		primitive.E{Key: "password_seted_at", Value: primitive.NewDateTimeFromTime(time.Now())},
