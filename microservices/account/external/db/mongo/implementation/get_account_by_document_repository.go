...
//
// microservices => account => external => db => mongo => implementation => get_account_by_document_repository.go
//
...
func (sMR *accountMongoRepository) GetAccountByDocumentRepository(document string) (*account.Account, error) {
