...
//
// microservices => auth => external => db => mongo => implementation => get_account_password_hash_by_email.go
//
...
func (sMR *authMongoRepository) GetAccountPasswordHashByEmailRepository(email string) (string, error) {
