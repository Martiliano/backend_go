...
//
// microservices => account => external => db => mongo => implementation => generate_recovery_password_token_repository_test.go
//
...
func TestGenerateRecoveryPasswordTokenRepository(t *testing.T) {
