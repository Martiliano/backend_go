...
//
// microservices => account => usecase => generate_recovery_password_token_test.go
//
...
func TestGenerateRecoveryPasswordToken_Success(t *testing.T) {
	...
	go func() {
		...
		err = usecase.GenerateRecoveryPasswordToken("62956508ccde2d63320a8a59")
...
func TestGenerateRecoveryPasswordToken_Error(t *testing.T) {
	...
	err = usecase.GenerateRecoveryPasswordToken("82956508ccde2d63320a8a59")
