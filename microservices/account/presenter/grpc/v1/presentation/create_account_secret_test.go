...
//
// microservices => account => presenter => grpc => v1 => presentation => account_server_test.go
//
//
...
func TestCreateAccountSecret_Success(t *testing.T) {
...
func TestCreateAccountSecret_InvalidSecret(t *testing.T) {
	...
	result, err := cli.CreateAccountSecret(ctx, &pb.CreateAccountSecretRequest{
		Secret: "no_secret_create_phrase",
		Account: &pb.AccountEntities{
			Id:            "62956508bbde2d63320a8a59",
			UserName:      "anyone",
			PhoneNumber:   "54988776655",
...
func TestCreateAccountSecret_InvalidPhoneNumber(t *testing.T) {
...
func TestCreateAccountSecret_InvalidEmail(t *testing.T) {
...
func TestCreateAccountSecret_InvalidDocument(t *testing.T) {
...
func TestCreateAccountSecret_InvalidRoles(t *testing.T) {
...
func TestCreateAccountSecret_InvalidTypeOfAccounts(t *testing.T) {
...
func TestCreateAccountSecret_ErrorEmailExists(t *testing.T) {
	...
	mockId, errMock := cli.CreateAccountSecret(ctx, &pb.CreateAccountSecretRequest{
		Secret: "secret_create_phrase",
		Account: &pb.AccountEntities{
			Id:            "62956508bbde2d63320a8a59",
			UserName:      "anyone",
...
func TestCreateAccountSecret_ErrorPhoneExists(t *testing.T) {
...
func TestCreateAccountSecret_ErrorDocumentExists(t *testing.T) {
